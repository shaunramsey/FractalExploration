...
Exponent. This should shorten the amount of time it takes to create the Lyapunov Logistic Fractal.
@author: Michelle
"""
...
num_warmups = 10            #our throwaway iterations to get the lyapunov exponent settled
iter = 10                   #iterations --the more iterations the more accurate
